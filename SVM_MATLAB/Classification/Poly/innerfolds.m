function [accuracy, bestParameters] = innerfolds(outer_train_features, outer_train_labels, ...
    ...
    Mdl = fitcsvm(outer_train_features, outer_train_labels, 'KernelFunction', 'polynomial', 'PolynomialOrder', bestParameters{1}, 'BoxConstraint', bestParameters{2}, 'Standardize', true);
