function [error, bestParameters] = innerfolds(outer_train_features, outer_train_labels, ...
    ...
    Mdl = fitrsvm(outer_train_features, outer_train_labels, 'Standardize', true, 'KernelFunction', 'polynomial', 'PolynomialOrder', bestParameters{1}, 'BoxConstraint', bestParameters{2}, 'epsilon', bestParameters{3}, 'Standardize', true);
