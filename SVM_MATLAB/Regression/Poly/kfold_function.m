function output = kfold_function(k, features, labels, kernelFunction, params)
	...
	for i = 0:k - 1
	    ...
	    Mdl = fitrsvm(train_features, train_labels, 'Standardize', true, 'KernelFunction', kernelFunction, 'PolynomialOrder', params{1}, 'BoxConstraint', params{2}, 'epsilon', params{3});
